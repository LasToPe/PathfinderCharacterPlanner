...
namespace PathfinderModelling.Repository
{
    public class Ranger
    {
        ...
        public Ranger()
        {
            ...
            Class.Archetypes.Add(AbengedoDiver);
            Class.Archetypes.Add(BattleScout);
            Class.Archetypes.Add(BeastMaster);
            Class.Archetypes.Add(Blightwarden);
        }
                ...
                return new Archetype
                {
                    ...
                    ArchetypeAbilities = new List<ArchetypeAbility>
                    {
                        new ArchetypeAbility
                        {
                            ...
                            Level = 1,
                            ReplacedAbilities = new List<ClassAbility>(Class.ClassAbilities.Where(a => a.Name == "Track"))
                        },
                        new ArchetypeAbility
                        {
                            Name = "Deep Diver",
                            Level = 1,
                            ReplacedAbilities = new List<ClassAbility>(Class.ClassAbilities.Where(a => a.Name == "Wild Empathy"))
                        },
                        new ArchetypeAbility
                        {
                            Name = "Aquatic Terrain +2",
                            Level = 3,
                            ReplacedAbilities = new List<ClassAbility>(Class.ClassAbilities.Where(a => a.Name == "1st Favored Terrain"))
                        },
                        new ArchetypeAbility
                        {
                            Name = "Aquatic Terrain +4",
                            Level = 8,
                            ReplacedAbilities = new List<ClassAbility>(Class.ClassAbilities.Where(a => a.Name == "2nd Favored Terrain"))
                        },
                        new ArchetypeAbility
                        {
                            Name = "Aquatic Terrain +6",
                            Level = 13,
                            ReplacedAbilities = new List<ClassAbility>(Class.ClassAbilities.Where(a => a.Name == "3rd Favored Terrain"))
                        },
                        new ArchetypeAbility
                        {
                            Name = "Aquatic Terrain +8",
                            Level = 18,
                            ReplacedAbilities = new List<ClassAbility>(Class.ClassAbilities.Where(a => a.Name == "4th Favored Terrain"))
                        },
                        new ArchetypeAbility
                        {
                            Name = "Aquatic Adaptation",
                            Level = 7,
                            ReplacedAbilities = new List<ClassAbility>(Class.ClassAbilities.Where(a => a.Name == "Woodland Stride"))
                        },
                        new ArchetypeAbility
                        {
                            Name = "Shark Sense",
                            Level = 8,
                            ReplacedAbilities = new List<ClassAbility>(Class.ClassAbilities.Where(a => a.Name == "Swift Tracker"))
                        },
                        new ArchetypeAbility
                        {
                            Name = "Killer of the Deep",
                            Level = 3,
                            ReplacedAbilities = new List<ClassAbility>(Class.ClassAbilities.Where(a => a.Name == "Master Hunter"))
                        },
                    }
                };
            }
                ...
                return new Archetype
                {
                    ...
                    ArchetypeAbilities = new List<ArchetypeAbility>
                    {
                        new ArchetypeAbility
                        {
                            Name = "Hunter's Bond",
                            Level = 4,
                            ReplacedAbilities = new List<ClassAbility>(Class.ClassAbilities.Where(a => a.Name == "Hunter's Bond"))
                        },
                        new ArchetypeAbility
                        {
                            Name = "Advantageous Terrain",
                            Level = 5,
                            ReplacedAbilities = new List<ClassAbility>(Class.ClassAbilities.Where(a => a.Name == "2nd Favored Enemy"))
                        },
                        new ArchetypeAbility
                        {
                            Name = "Infiltration",
                            Level = 10,
                            ReplacedAbilities = new List<ClassAbility>(Class.ClassAbilities.Where(a => a.Name == "3rd Favored Enemy"))
                        },
                        new ArchetypeAbility
                        {
                            Name = "Superior Tactics",
                            Level = 15,
                            ReplacedAbilities = new List<ClassAbility>(Class.ClassAbilities.Where(a => a.Name == "4th Favored Enemy"))
                        },
                        new ArchetypeAbility
                        {
                ...
                return new Archetype
                {
                    ...
                    ArchetypeAbilities = new List<ArchetypeAbility>
                    {
                        ...
                        new ArchetypeAbility
                        {
                            ...
                            Level = 6,
                            ReplacedAbilities = new List<ClassAbility>(Class.ClassAbilities.Where(a => a.Name == "Combat Style Feat" && a.Level == 6))
                        },
                        new ArchetypeAbility
                        {
                            Name = "Strong Bond",
                            Level = 12,
                            ReplacedAbilities = new List<ClassAbility>(Class.ClassAbilities.Where(a => a.Name == "Camouflage"))
                        },
                    }
                };
            }
                ...
                return new Archetype
                {
                    ...
                    ArchetypeAbilities = new List<ArchetypeAbility>
                    {
                        new ArchetypeAbility
                        {
                            ...
                            Level = 1,
                            ReplacedAbilities = new List<ClassAbility>(Class.ClassAbilities.Where(a => a.Name == "1st Favored Enemy"))
                        },
                        new ArchetypeAbility
                        {
                            Name = "Emulate Taint",
                        ...
                        new ArchetypeAbility
                        {
                            ...
                            Level = 3,
                            ReplacedAbilities = new List<ClassAbility>(Class.ClassAbilities.Where(a => a.Name == "Endurance"))
                        },
                    }
                };
            }
